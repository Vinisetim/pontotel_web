...
PASTA_SHAREPOINT_ARQUIVO = Path(
    r"C:\Users\vinicius.gomes\JTP TRANSPORTES, SERVICOS, GERENCIAMENTO E RECURSOS HUMANOS LTDA\Gente & Gestão - Arquivo"
)
...
TEMPO_ESPERA_PADRAO = 40

TEMPO_ESPERA_DOWNLOAD = 1000
